/**
 * @generated SignedSource<<c42453407af1d3c24d9a3dd56a6fedc0>>
...
export type UserRecruitmentsQuery$variables = {
  after?: string | null;
  first?: number | null;
  id: string;
};
export type UserRecruitmentsQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"UserRecruitmentCardList_user">;
  } | null;
};
export type UserRecruitmentsQuery = {
  response: UserRecruitmentsQuery$data;
  variables: UserRecruitmentsQuery$variables;
};
